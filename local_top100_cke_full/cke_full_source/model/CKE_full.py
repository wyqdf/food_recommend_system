...
class CKE(nn.Module):
    ...
    def calc_scae_loss(self, masked_visual_embed, visual_embed):
        ...
        encoded_embed = encoded_embed.reshape([scae_batch_size, -1])
        ...
        decoded_embed = decoded_embed.reshape([scae_batch_size, encoder_channel, image_height, image_width])
    ...
    def generate_item_cf_embed(self, item_ids, item_textual_embed, item_visual_embed):
        ...
        item_scae_embed = item_scae_embed.reshape([scae_batch_size, -1])
